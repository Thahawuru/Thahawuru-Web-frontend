...
const Footer: React.FC = () => {
  return (
    <footer
      className="w-full bg-gradient-to-br from-secondary to-secondaryTwo p-4 sm:p-8 md:p-12 lg:p-10"
      style={{ zIndex: 1 }}
    >
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div className="mb-6 md:mb-0">
              ...
              <ul className="text-gold-500 dark:text-gold-400 font-medium">
                <li className="mb-2 text-center md:text-left">
                  <a
                    href="https://thahawuru-docs.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-gold hover:bg-gradient-to-r from-white to-white bg-clip-text hover:text-transparent"
                  >
                    docs
                  </a>
                </li>
        ...
        <div className="sm:flex text-center md:text-left sm:justify-between">
          <span className="text-gold text-gold-500 dark:text-gold-400">
            ...
            <Link
              href="/"
              className="text-gold hover-text hover:bg-gradient-to-r from-white to-white bg-clip-text hover:text-transparent"
            >
              Thahawuru
            </Link>
            . All Rights Reserved.

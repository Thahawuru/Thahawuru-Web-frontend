      ...
      <div className="flex flex-col justify-between items-center w-full h-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 w-full h-auto bg-gradient-to-br from-white to-primary p-0 md:p-4 mt-10">
          {tiles.map((tile) => (
            <div
              key={tile.title}
              className="flex flex-col w-full h-full justify-center items-center bg-white rounded-lg md:shadow-md m-0 md:m-2 p-4 md:p-10  transition duration-300 ease-in-out transform cursor-pointer"
            >
